...
<body>
 		...
 		<div class="container">
 			<div class="row">
 				<div class="col-sm-4 wow flipInY">
 					...
 					<h3><a class="fontoswald" href="">Our Restaruant Story</a></h3>
 					<p class="fontroboto">Sed ut perspiciatis unde omnis iste natus errorsit voluptatem accusantium doloremque laudantium thes hatles tooest surf totam rem aperiam.</p>
 				...
 				<div class="col-sm-4 wow flipInY" data-wow-delay="0.4s">
 					<a href=""><img src="images/anhdv03.jpg" alt="" class="img-fluid"></a>
 					<h3><a class="fontoswald" href="">Our Restaruant Story</a></h3>
 					<p class="fontroboto">Sed ut perspiciatis unde omnis iste natus errorsit voluptatem accusantium doloremque laudantium thes hatles tooest surf totam rem aperiam.</p>
 					<a href="" class="readmore fontroboto">Read More</a>
 				</div>
	...
	<div class="thucdonct wow fadeInUp">
		<div class="tieudect text-xs-center fontroboto">
			...
			<a href="" data-monan=".sang">Bữa sáng</a>
			<a href="" data-monan=".trua">Bữa trưa</a>
			<a href="" data-monan=".toi">Bữa tối</a>
		</div>
		<div class="noidungct">
			<div class="container">
						...
						<div class="row">
							<div class="col-xs-3 col-sm-4">
								<div class="anhmon">
									...
									<img src="images/anhdv01.jpg" alt="" class="img-fluid">
								</div>
							</div>
							<div class="col-xs-9 col-sm-8">
								<div class="tenmon">
									<div class="tren">
										<span class="float-xs-right">150.000đ</span>
										<b class="ten">Trứng Ốp La Vàng Trắng</b>
									</div>
									<div class="duoi">
										Hến với sốt cà chua, rượu vang
									</div>
								</div>
							</div>
						</div> <!-- het row -->
							...
							<div class="carousel-item active">
								<div class="row">
									<div class="sanpham">
										...
										<div class="tensp">
											<div class="gia float-xs-right">200.000đ</div>
											<div class="ten">Sườn chua ngọt</div>
										</div>
										<div class="tencongthuc">
											Sườn và xà lách, coca cola
										</div>
									</div> <!-- SAN PHAM -->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-7 push-sm-1">
					<div class="thongtin">
						<h2 class="fontoswald">Cristiano Messi</h2>
			...
			<div class="row">
				<div class="col-sm-6 push-sm-3">
					<div class="thongtindatban fontroboto">
						...
						<p class="giodb">Monday to Friday <span class="vang"> 9:00 am - 23:00 pm </span> Saturday to Sunday <span class="vang"> 10:00 am - 22:00 pm </span> Note: Arctica Restaurant is closed on holidays.</p>
						<div class="dtdb fontoswald">0844.335.1211</div>
					</div>
				</div>
				<div class="col-sm-10 push-sm-1">
					<div class="formdatban">
						<div class="row">
							...
							<div class="col-sm-4">
								<div class="form-group">
									<input type="time" class="form-control" placeholder="Thời gian *">
								</div>
							</div>
							<div class="col-sm-4">
								<div class="form-group">
									<input type="number" class="form-control" placeholder="Không có người *">
								</div>
							</div>
							<div class="col-sm-12 text-xs-center">
								<a href="" class="btn btn-warning datban2">
									Đặt bàn ngay
								</a>
							</div>
						</div>
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-2 col-xs-12 wow flipInY">
					<div class="mottinchuan">
						<a href=""><img src="images/f1-01.jpg" alt=""></a>
						<a href="" class="tieudetin1 fontoswald">Ingredients For Cooking Pasta</a>
